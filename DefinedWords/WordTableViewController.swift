...
class WordTableViewController: UITableViewController {
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        cell.wordLabel?.text = wordManager.words[indexPath.row]
    ...
    */
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        if segue.identifier == "ShowDefinition" {
            let wordDefinitionViewController = segue.destinationViewController as! WordViewController
            // Get the cell that generated this segue.
            if let selectedWordCell = sender as? WordTableViewCell {
                let indexPath = tableView.indexPathForCell(selectedWordCell)!
                let selectedWord = wordManager.words[indexPath.row]
                wordDefinitionViewController.word = selectedWord
            }
        }
